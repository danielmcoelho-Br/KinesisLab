            ...
            {isOpen && (
                <div style={{ 
                    ...
                    <motion.div 
                        ...
                        style={{ 
                            backgroundColor: '#1e293b', // Dark background for professional look
                            width: '100%', 
                            maxWidth: '1400px', 
                            height: '95vh',
                            borderRadius: '1.5rem', 
                    ...
                    >
                        ...
                        <div style={{ 
                            ...
                            <div style={{ display: 'flex', backgroundColor: '#334155', borderRadius: '12px', padding: '4px', gap: '4px' }}>
                                <ToolButton active={currentTool === 'brush'} onClick={() => setCurrentTool('brush')} icon={<Pencil size={18}/>} label="PINCEL" />
                        ...
                        <div style={{ padding: '0.75rem 1.5rem', display: 'flex', justifyContent: 'space-between', backgroundColor: '#1e293b' }}>
                            <div style={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                <IconButton icon={<Eraser size={16}/>} label="Apagar" color="#ef4444" bg="rgba(239, 68, 68, 0.1)"/>
                            </div>
                            <div style={{ display: 'flex', gap: '0.5rem' }}>
