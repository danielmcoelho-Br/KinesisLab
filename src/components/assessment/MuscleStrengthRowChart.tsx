    ...
    return (
        <div style={{ 
            ...
            <div style={{ position: 'relative', display: 'flex', gap: '0.75rem', alignItems: 'flex-end', height: '180px', paddingBottom: '0.5rem' }}>
                ...
                {prevE > 0 && <Bar value={prevE} maxValue={maxValue} label={prevDate} subLabel="Esquerda Ant." color="var(--primary-light)" unit="kgf" isPrint={isPrint} />}
                <Bar value={currE} maxValue={maxValue} label={assessmentDate} subLabel="Esquerda" color="var(--primary)" unit="kgf" isPrint={isPrint} />

                <div style={{ height: '140px', width: '2px', backgroundColor: '#f1f5f9', marginBottom: '40px' }} />

                {prevD > 0 && <Bar value={prevD} maxValue={maxValue} label={prevDate} subLabel="Direita Ant." color="#fda4af" unit="kgf" isPrint={isPrint} />}
                <Bar value={currD} maxValue={maxValue} label={assessmentDate} subLabel="Direita" color="var(--primary-light)" unit="kgf" isPrint={isPrint} />
            </div>
